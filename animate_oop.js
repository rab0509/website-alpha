function initCanvas() {
	...
	function animate() {
		...
		rect2.render(ctx, rect2.x*0.5, rect2.y, rect2.w, rect2.h, "blue");
		rect3.render(ctx, rect3.x*2, rect3.y, rect3.w, rect3.h, "orange");
		rect4.render(ctx, rect4.x*2.5, rect4.y, rect4.w, rect4.h, "red");
		rect1.x++;												                      // increment x position by 1 pixel
		rect2.x++;												                      // increment x position by 1 pixel
		rect3.x++;												                      // increment x position by 1 pixel
		rect4.x++;												                      // increment x position by 1 pixel		
